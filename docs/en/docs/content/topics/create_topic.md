...
Create a new community topic on [Topics](https://longport.com/topics). Two content types are supported:
...
| 403    | Forbidden — user has not opened a LongPort account or has no assets  | None                                                  |
