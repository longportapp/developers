...
export const zhHKConfig: LocaleSpecificConfig<DefaultTheme.Config> = {
  head: [
    ...
    ['meta', { property: 'og:title', content: 'LongPort Developers：靈活支持程序化交易' }],
    [
      'meta',
      {
        property: 'og:description',
        content: 'LongPort Developers 為您提供靈活多樣的接入服務，滿足您的量化交易需求，快速構建您的交易策略。',
      },
    ],
    [
      'meta',
  ...
  description: 'LongPort Developers 為您提供靈活多樣的接入服務，滿足您的量化交易需求，快速構建您的交易策略。',
