...
LongPort 不針對接口服務額外收取開通或使用費用，只需[開通 LongPort 綜合帳戶](https://longport.com/hk/download)及 OpenAPI 服務權限即可免費使用。行情數據訂閱費用可通過「LongPort」手機客戶端，進入「我的 - 我的行情 - 行情商城」查看。實際交易費率請洽詢您開通證券帳戶的券商。
