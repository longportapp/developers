...
resp = ctx.finance_calendar(CalendarCategory.Split, "2026-01-01", "2026-12-31")
print(resp)
```
...
async def main() -> None:
    ...
    resp = await ctx.finance_calendar(CalendarCategory.Split, "2026-01-01", "2026-12-31")
    print(resp)
...
func main() {
	...
	defer c.Close()
	resp, err := c.FinanceCalendar(context.Background(), "Split", "2026-01-01", "2026-12-31")
	if err != nil {
		log.Fatal(err)
	}
	fmt.Printf("%+v\n", resp)
