...
async function main() {
  ...
  const resp = await ctx.financeCalendar(CalendarCategory.Report, "2026-01-01", "2026-12-31")
  console.log(resp)
}
...
int main() {
    OAuthBuilder("your-client-id").build(
        ...
        [](auto res) {
            ...
            CalendarContext ctx = CalendarContext::create(config);
            ctx.finance_calendar(CalendarCategory::Report, "2026-01-01", "2026-12-31", "", [](auto resp) {
