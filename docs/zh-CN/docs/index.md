...
LongPort 不针对接口服务额外收取开通或使用费用，只需[开通 LongPort 综合账户](https://longport.com/hk/download)及 OpenAPI 服务权限后即可免费使用。行情数据订阅费用详见[定价页面](/zh-CN/pricing)。实际交易费率请咨询您开通证券账户的券商。
