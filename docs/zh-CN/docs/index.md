...
LongPort Developers 为有研发能力的投资者提供程序化接口，助力投资者根据自身投资策略搭建交易或行情策略分析工具。平台覆盖以下类别：
...
1. 登录 [LongPort App](https://longport.com/download) 完成开户；
2. 登录 [longport.com](https://longport.com) 进入开发者平台，完成开发者认证即 OpenAPI 权限申请，获取令牌。
...
我们 [OpenAPI SDK](https://open.longport.com/sdk) 内部已经做了有效的频率控制：
...
LongPort 不针对接口服务额外收取开通或使用费用，只需[开通 LongPort 综合账户](https://longport.com/hk/download)及 OpenAPI 服务权限后即可免费使用。行情数据订阅费用可通过“LongPort”手机客户端，进入“我的 - 我的行情 - 行情商城”查看。实际交易费率请咨询您开通证券账户的券商。
